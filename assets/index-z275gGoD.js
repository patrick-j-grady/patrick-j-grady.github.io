...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ts,depthTest:!1,depthWrite:!1})}function Lh(){return new Hi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Fl(),fragmentShader:`
		...
		`,blending:ts,depthTest:!1,depthWrite:!1})}function Ih(){return new Hi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Fl(),fragmentShader:`
